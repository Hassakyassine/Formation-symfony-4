 ...
 * @UniqueEntity(
 *  fields={"email"} ,
 *  message="Un autre utilisateur s'est déja inscrit avec adresse email, merci de la modifier"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Length(min=100, minMessage="Votre introduction doit faire au moins 10 caractéres")
     */
    private $description;
