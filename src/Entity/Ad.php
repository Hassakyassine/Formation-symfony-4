...
class Ad
{
     ...
     * @Assert\length(min=20 ,minMessage="Votre introduction doit faire de 20 caractéres")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\length(min=100 ,minMessage="Votre introduction doit faire de 100 caractéres")
     */
    private $content;
    ...
    public function getNotAvailableDays(){
        ...
        foreach($this->bookings as $booking){
            // calculer les jours qui ne se trouvent entre la date d'arrivé et de départ
            $resultat = range(
